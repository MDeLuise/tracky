...
function ObservationTableBody(props: {
    ...
    const formatObservationInstant = (ob: observation): string => {
...
export default function Tracker(props: {
    ...
    const getObservation = (getPageNo: number, getElementsPerPage: number): void => {
        ...
        props.requestor.get(`observation?pageNo=${getPageNo}&pageSize=${getElementsPerPage}&sortBy=instant&sortDir=DESC`)
            .then(response => {
