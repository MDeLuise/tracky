package com.github.mdeluise.tracky.security.jwt;
...
public class JwtWebUtil {
    ...
    @Autowired
    public JwtWebUtil(com.github.mdeluise.tracky.security.jwt.JwtTokenUtil jwtTokenUtil, UserDetailsService userDetailsService) {
    ...
    public com.github.mdeluise.tracky.security.jwt.JwtTokenInfo refreshToken(String token) {
    ...
    public com.github.mdeluise.tracky.security.jwt.JwtTokenInfo generateJwt(UserDetails user) {
        return jwtTokenUtil.generateAccessToken(user);
    }
}
